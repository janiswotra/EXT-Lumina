    ...
    <div className="w-[320px] bg-gray-50 min-h-[400px] flex flex-col font-sans text-gray-900">
      ...
      <main className="flex-1 p-6 flex flex-col items-center justify-center text-center">
        ...
        <div className="space-y-4">
          ...
          <h2 className="text-lg font-semibold text-gray-800">Extension Active</h2>
          <p className="text-sm text-gray-600">
            Navigate to any LinkedIn Profile and look for the <span className="font-bold text-indigo-600">✦ Lumina</span> button on the right side of the screen.
          </p>
        </div>
      </main>
