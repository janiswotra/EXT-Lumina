import { ENVIRONMENTS, ACTIVE_ENV_KEY, STORAGE_KEYS, EnvConfig, getEnvById } from '../app/core/constants';
import { ExtensionMessage, ApiResponse, SyncMessagesPayload, CheckCandidateStatusPayload } from '../app/core/types';
import { normalizeLinkedInUrl, extractLinkedInMemberId } from '../app/core/utils/linkedin';
import { validateProfileBeforeSave } from '../app/core/utils/validation';
